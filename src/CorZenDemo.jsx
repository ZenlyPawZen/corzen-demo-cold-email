...
const steps = [
  {
    slug: 'agents/cold-email',
    image: '/images/step1.png',
    altText: 'Introduction to the Write Cold Emails feature in CorZen',
    title: 'Write Cold Emails',
    description: 'Start new customer relationships. Create humanized cold email that get replies.',
    intro: true,
    hotspot: null,
  },
  {
    slug: 'agents/cold-email/detail',
  ...
  },
  {
    ...
    altText: 'Write Cold Emails agent running autonomously',
    title: 'Step 2',
    description: 'Stop chasing the perfect prompt and start generating leads.',
    hotspot: { top: '50%', left: '50%', align: 'center' },
  },
  {
    slug: 'agents/cold-email/output',
  ...
  return (
    ...
    <div className="rounded-xl bg-white overflow-hidden font-sans" style={{ border: '3px solid #0f172a', boxShadow: '0 8px 32px rgba(0,0,0,0.18)' }}>
      ...
      <div className="bg-slate-50 border-b border-slate-200 p-3 flex items-center justify-center">
        <span className="font-bold text-slate-900 text-sm tracking-tight">Agent Demo to Write Cold Emails</span>
      </div>
